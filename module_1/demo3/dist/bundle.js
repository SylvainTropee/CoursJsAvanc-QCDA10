(() => {
        ...
        56: (e, t, n) => {
            ...
            function r(e, r) {
                for (var a = {}, i = [], s = 0; s < e.length; s++) {
                    var c = e[s], u = r.base ? c[0] + r.base : c[0], l = a[u] || 0, d = "".concat(u, " ").concat(l);
                    a[u] = l + 1;
                    var p = n(d), f = {css: c[1], media: c[2], sourceMap: c[3], supports: c[4], layer: c[5]};
            ...
            const e = document.getElementById("selectBeer");
            ["Paix-Dieu", "La chouffe", "Kro", "Maximator", "86", "Leffe"].forEach((function (t) {
                let n = document.createElement("option");
                n.value = t.toLowerCase(), n.innerText = t, e.append(n)
            }));
            let t = document.createElement("p");
            document.body.append(t), e.addEventListener("change", (function () {
                console.log(this), t.innerText = this.value, t.style.textTransform = "capitalize"
            }))
        }, 275: (e, t, n) => {
            "use strict";
            n.d(t, {A: () => s});
            var r = n(601), o = n.n(r), a = n(314), i = n.n(a)()(o());
            i.push([e.id, '/*! tailwindcss v4.1.7 | MIT License | https://tailwindcss.com */\n@layer properties;\n.flex {\n  display: flex;\n}\n.justify-center {\n  justify-content: center;\n}\n.border {\n  border-style: var(--tw-border-style);\n  border-width: 1px;\n}\n.capitalize {\n  text-transform: capitalize;\n}\n@property --tw-border-style {\n  syntax: "*";\n  inherits: false;\n  initial-value: solid;\n}\n@layer properties {\n  @supports ((-webkit-hyphens: none) and (not (margin-trim: inline))) or ((-moz-orient: inline) and (not (color:rgb(from red r g b)))) {\n    *, ::before, ::after, ::backdrop {\n      --tw-border-style: solid;\n    }\n  }\n}', ""]);
            const s = i
        }, 314: e => {
            "use strict";
            e.exports = function (e) {
    ...
    n.n = e => {
        ...
        "use strict";
        n(177);
        var e = n(72), t = n.n(e), r = n(825), o = n.n(r), a = n(659), i = n.n(a), s = n(56), c = n.n(s), u = n(540),
            l = n.n(u), d = n(113), p = n.n(d), f = n(275), v = {};
        v.styleTagTransform = p(), v.setAttributes = c(), v.insert = i().bind(null, "head"), v.domAPI = o(), v.insertStyleElement = l(), t()(f.A, v), f.A && f.A.locals && f.A.locals
    })()
})();